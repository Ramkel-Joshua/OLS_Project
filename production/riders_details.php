        ...
        <div class="">
          <div class="page-title">
            <div class="title_left">
              <a href="add_riders.php"><button style="margin-top: 8px;" type="button" class="btn btn-success" ><i class="fa fa-plus"></i> Add New</button></a>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>RIDERS' INFORMATION TABLE</h2>
