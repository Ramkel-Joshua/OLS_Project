        ...
        <div class="">
          <div class="page-title">
            <div class="title_left">
                <a href="proPic.php"><button style="margin-top: 8px;" type="button" class="btn btn-success" ><i class="fa fa-user"></i> Change Profile</button></a>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>USER'S INFORMATION TABLE</h2>
