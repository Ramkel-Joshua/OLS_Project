...
if(isset($_POST['submit1'])){
    ...
    $password = $_POST['password'];
      ...
      $update=mysqli_query($conn,"update users set fullname='".$name."', username='".$username."', password='".$password."', address='".$address."', contact='".$cont."'");
}
                ...
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        ...
                        <div class="x_content" style="margin-left: 300px;margin-bottom: 20px;  ">
                            ...
                            <?php
                              $slelee=mysqli_query($conn,"select * from users");
                              $row=mysqli_fetch_array($slelee);
                            ?>
                          <label>Full Names:</label>
                            <div class="form-group row">
												      <input type="text" class="form-control" name="fullname" style="width:450px" value="<?php echo $row['fullname']; ?>" >
											      </div>
                                                  <label>Username:</label>
                            <div class="form-group row">
											        
												      <input type="text" class="form-control" name="username" style="width:450px" value="<?php echo $row['username']; ?>">
											      </div>
                                                  <label>Password:</label>
                            <div class="form-group row">
											        
												      <input type="text" class="form-control" name="password" style="width:450px" value="<?php echo $row['password']; ?>">
											      </div>
                                                  <label>Phone Number:</label>
                            <div class="form-group row">
											        
												      <input type="text" class="form-control" name="contact" style="width:450px" value="<?php echo $row['contact']; ?>">
											      </div>
                                                  <label>Address:</label>
                            <div class="form-group row">
											        
												      <input type="text" class="form-control" name="address" style="width:450px" value="<?php echo $row['address']; ?>">
											      </div>
